...
output_file = os.path.join(args.output_path, "ocr_text_onevision_inference_results.jsonl")
...
for idx, entry in enumerate(json_data[start:], start=start):
    ...
    for conv in entry["conversations"]:
        if conv["from"] == "human":
            ...
            # <image> 제거 (Onevision은 chat_template로 이미지 넣음)
